...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        if ($password === $user['password']) {
            // Check status (default 'aktif' if not provided but let's be safe)
...
<input class="block w-full h-[40px] pl-10 pr-3 py-2 border border-border rounded bg-surface-container-lowest text-on-surface focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent font-body-md text-body-md transition-shadow" id="email" name="email" placeholder="name@company.com" required="" type="email">
</div>
</div>
<!-- Password Input -->
<div>
...
<input class="h-4 w-4 text-primary focus:ring-primary border-border rounded bg-surface-container-lowest cursor-pointer" id="remember-me" name="remember-me" type="checkbox">
...
<p class="font-body-sm text-body-sm text-on-surface-variant">
                    ...
                    <a class="font-label-md text-label-md text-primary hover:text-primary-container transition-colors ml-1" href="register.php">Sign up</a>
</p>
</div>
</div>
<!-- Footer / Legal Info -->
